...
const SongBar = () => {
    ...
    const backwardSong = () => {
        ...
        // Pause the current song and reset if necessary
        if (masterSong.mp3) {
            masterSong.mp3.pause();
        ...
        // Update the song index and dispatch the action
        const newIndex = songIdx - 1;
        console.log("New index:", newIndex);
        setSongIdx(newIndex);
        console.log("Dispatching action to play:", songss[newIndex]);
        dispatch(playSong(songss[newIndex]));
    };
    
    const forwardSong = () => {
    if (songIdx >= songss.length - 1) {
