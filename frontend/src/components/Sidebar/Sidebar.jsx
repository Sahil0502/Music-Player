...
const Sidebar = () => {
  ...
  return (
    <div className="w-1/4 fixed left-0 mt-2 top-0 sidebar ">
      {/* add white_logo.png */}
{/*  
        <img src="/assets/white_logo.png" alt="" width={50} height={50} /> */}

      <div className="nav secondary_bg rounded-lg p-4">
        <img src="/assets/white_logo.png" alt="" width={80} height={50} />
        <Link to={"/"} className="flex items-center gap-6 mt-3">
